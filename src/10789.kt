...
//
//    val str = Array(size = 15) { StringBuilder(5) }
//    repeat(times = 5) {
//        reader.readLine().forEachIndexed { i: Int, ch: Char -> str[i].append(ch) }
//    }
//    str.forEach { writer.write(it.toString()) }
//    writer.flush()
